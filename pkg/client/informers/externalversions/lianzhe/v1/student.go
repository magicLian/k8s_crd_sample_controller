...
import (
	...
	v1 "k8s_customize_controller/pkg/client/listers/lianzhe/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LianzheV1().Students(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LianzheV1().Students(namespace).Watch(options)
			},
		},
		&lianzhev1.Student{},
		resyncPeriod,
...
func (f *studentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lianzhev1.Student{}, f.defaultInformer)
}
