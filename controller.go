...
import (
	...
	lianzhev1 "k8s_customize_controller/pkg/apis/lianzhe/v1"
	...
	informers "k8s_customize_controller/pkg/client/informers/externalversions/lianzhe/v1"
	listers "k8s_customize_controller/pkg/client/listers/lianzhe/v1"
)
...
func NewController(
	...
	studentInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(old, new interface{}) {
			oldStudent := old.(*lianzhev1.Student)
			newStudent := new.(*lianzhev1.Student)
